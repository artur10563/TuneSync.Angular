...
import { PageInfo, PaginatedResponse } from "../../models/Responses/PaginatedResponse.model";
...
export class GenericSongSource<TService> extends BaseSongSource {
    constructor(
        ...
        private fetchFunction: (page: number) => Observable<PaginatedResponse<Song, SongMetadata>>) {
        super();
    }
